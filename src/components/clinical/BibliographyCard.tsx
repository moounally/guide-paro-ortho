...
const citations = [
  {
    id: 1,
    text: "Ounally Z., Dallel I. (2026). Impact des dispositifs orthodontiques sur la santé parodontale : aligneurs transparents versus systèmes multi-attaches — revue systématique de la littérature. Thèse de doctorat en médecine dentaire, Univ. Monastir.",
    link: "#",
